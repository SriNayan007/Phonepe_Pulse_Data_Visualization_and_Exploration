...
if select == "Home":
    ...
    with col3:
        st.video("https://www.youtube.com/watch?v=6V7WbsZ9bz4")
    ...
    with col6:
        st.video("https://www.youtube.com/watch?v=rCmXuJTEajA")
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        if method_map == "Map Insurance Analysis":
            col1,col2= st.columns(2)
            with col1:
                years_m1= st.slider("**Select the Year_mi**",int(Map_insurance["Years"].min()),int(Map_insurance["Years"].max()),int(Map_insurance["Years"].min()))
            ...
            col1,col2= st.columns(2)
            with col1:
                quarters_m1= st.slider("**Select the Quarter_mi**",int(df_map_insur_Y["Quarter"].min()),int(df_map_insur_Y["Quarter"].max()),int(df_map_insur_Y["Quarter"].min()))
            ...
            col1,col2= st.columns(2)
            with col1:
                years_m2= st.slider("**Select the Year_mi**",int(Map_transaction["Years"].min()),int(Map_transaction["Years"].max()),int(Map_transaction["Years"].min()))
            ...
            col1,col2= st.columns(2)
            with col1:
                quarters_m2= st.slider("**Select the Quarter_mi**",int(df_map_tran_Y["Quarter"].min()),int(df_map_tran_Y["Quarter"].max()),int(df_map_tran_Y["Quarter"].min()))
    ...
    with tab3:
        ...
        if method_top == "Top Insurance Analysis":
            col1,col2= st.columns(2)
            with col1:
                years_t1= st.slider("**Select the Year_ti**",int(Top_insurance["Years"].min()),int(Top_insurance["Years"].max()),int(Top_insurance["Years"].min()))
            ...
            col1,col2= st.columns(2)
            with col1:
                quarters_t1= st.slider("**Select the Quarter_ti**",int(df_top_insur_Y["Quarter"].min()),int(df_top_insur_Y["Quarter"].max()),int(df_top_insur_Y["Quarter"].min()))
            ...
            col1,col2= st.columns(2)
            with col1:
                years_t2= st.slider("**Select the Year_tt**",int(Top_transaction["Years"].min()),int(Top_transaction["Years"].max()),int(Top_transaction["Years"].min())) 
            df_top_tran_Y= Aggre_insurance_Y(Top_transaction,years_t2)

            
            col1,col2= st.columns(2)
            with col1:
                quarters_t2= st.slider("**Select the Quarter_tt**",int(df_top_tran_Y["Quarter"].min()),int(df_top_tran_Y["Quarter"].max()),int(df_top_tran_Y["Quarter"].min()))
